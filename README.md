...
* [`src/cljs/appezia/`](src/cljs/appezia/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/appezia/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `appezia` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/appezia/config.cljs) defaults to `true` in
...
```clj
(ns appezia.example
  (:require [appezia.config :as config])
